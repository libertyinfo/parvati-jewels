    ...
    return (
        <div>
            ...
            <section className="relative 3xl:h-[380px] 2xl:h-[400px] xl:h-[675px] h-[498px] flex items-center overflow-hidden bg-[#227b8e] py-6">
                ...
                <ScrollReveal animation="fade-left" duration={900} delay={150} className="absolute w-[590px] xl:w-[800px] 2xl:w-[602px] 3xl:w-[37%] right-[12%] 3xl:right-[6%]">
            ...
            <section className='container mx-auto px-6 mb-24'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-24'>
                    <ScrollReveal animation="fade-up" delay={0} className="flex flex-col items-center justify-center py-10 px-8 bg-white shadow-[0_0_15px_rgba(0,0,0,0.1)] transition-transform hover:-translate-y-1 duration-300">
                        <div className="mb-5">
                    ...
                    <ScrollReveal animation="fade-up" delay={150} className="flex flex-col items-center justify-center py-10 px-8 bg-white shadow-[0_0_15px_rgba(0,0,0,0.1)] transition-transform hover:-translate-y-1 duration-300">
                        <div className="mb-5">
                    ...
                    <ScrollReveal animation="fade-up" delay={300} className="flex flex-col items-center justify-center py-10 px-8 bg-white shadow-[0_0_15px_rgba(0,0,0,0.1)] transition-transform hover:-translate-y-1 duration-300">
                        <div className="mb-5">
